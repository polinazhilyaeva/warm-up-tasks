/*
1 Написать функцию isPalindrome
Функция принимает число и возвращает true, если переданное число - палиндром

2 Написать функцию fiboCounter
Функция принимает два числа и возвращает количество чисел Фибоначчи попавших в данный диапазон

3 Написать функцию fiboEvaluator
Функция принимает число n и возвращает количество чисел Фибоначчи, имеющих длину n
*/
